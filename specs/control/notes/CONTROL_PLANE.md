...
Envelope:
- RPC wire format is defined by `specs/protocol/include/transport.h` and `specs/protocol/include/protocol.h`
...
- Events MUST be schema-versioned and tracked in `specs/control/schema/control_plane.v1.json` and `REGISTRY.md`.
